        ...
        {search ? (
          ...
          <div className="container mx-auto lg:px-8 px-4 py-4 w-full">
            <div className="flex items-center justify-between">
              <h1 className="text-white text-sm xl:text-xl font-bold md:text-2xl">ComicThur ID</h1>
              <div className="flex items-center gap-4">
                <div className="flex items-center">
                  <Search onClick={() => setSearch(!search)} className="text-gray-500 self-end md:size-9" />
                </div>
